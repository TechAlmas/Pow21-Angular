...
@Component({
  selector: 'mio-business-followers',
  templateUrl: './business-followers.component.html',
  styleUrls: ['./business-followers.component.css']
})
export class BusinessFollowersComponent implements OnInit {
...
UserDetail= new UserDetail();
 ...
 getUser(){
  ...
  getUserDetails(id){
  	return this._http.get<Ret[]>('dispensary_followers?slug='+id);
  }
  ngOnInit() {
window.scrollTo(0, 0);
  //this.loadMetaData();

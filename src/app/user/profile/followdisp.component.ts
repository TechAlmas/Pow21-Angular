...
@Component({
  ...
  templateUrl: './followdisp.component.html',
  styleUrls: ['./followdisp.component.css']
})
export class FollowdispComponent implements OnInit {
...
user_data: any;
  ...
  getFavstrain(){
    ...
    return this._http.get<Ret[]>('following_dispensary?user_id='+this.user_data['id']);
  }
  ngOnInit() {
    window.scrollTo(0, 0);
  //this.loadMetaData();
